...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-07 09:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f3db9da2-3c12-4e48-bfcf-c6afd09fc0cc.git
$ cd f3db9da2-3c12-4e48-bfcf-c6afd09fc0cc
```
